...
def admin_sponsors_page():
    ...
    edited_df = st.data_editor(
        ...
        column_config={
            ...
            "active": st.column_config.CheckboxColumn("Aktief"),
            "start_date": st.column_config.TextColumn("Begin Datum", help="Gebruik YYYY-MM-DD, byvoorbeeld 2026-08-05."),
            "end_date": st.column_config.TextColumn("Einddatum", help="Gebruik YYYY-MM-DD, byvoorbeeld 2026-09-05."),
